...
_vlm_client = OpenAI(
    api_key=_settings.nvidia_vlm_api_key or _settings.nvidia_api_key or "missing",
    base_url=_settings.nvidia_base_url,
    timeout=_settings.vlm_timeout_seconds,
)
_embed_client = OpenAI(
    api_key=_settings.nvidia_embed_api_key or _settings.nvidia_api_key or "missing",
    base_url=_settings.nvidia_base_url,
...
def _embed_call(texts: list[str]) -> list[list[float]]:
    ...
    resp = _embed_client.embeddings.create(
        ...
        dimensions=_settings.embed_dim,
